...
@Component({
  selector: 'app-carddetailview',
  templateUrl: './carddetailview.page.html',
  styleUrls: ['./carddetailview.page.scss'],
})
export class CarddetailviewPage implements OnInit {
  ...
  constructor(
    ...
    // this.childData = this.dataShareService.getchildCardData.subscribe(data =>{
  ...
  ngOnInit() {
    ...
    // ).subscribe(() => {
    //   this.childCardData = this.dataShareService.getchildCardData();
    //   this.childDataTitle = this.childCardData.title;
    //   console.log(this.childDataTitle);
    // }
  }
